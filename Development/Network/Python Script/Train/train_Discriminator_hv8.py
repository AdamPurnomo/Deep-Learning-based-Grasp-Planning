...
data_path = r'..\..\Training Data\Discriminator\hv8'
...
model.save_weights(r'..\..\Training Output\Weights\Discriminator_hv8.h5')
N = np.arange(0, Epochs)
History = np.array([N, tl, ta, tp, vl, va, vp])
np.save(r'..\..\Training Output\History\Discriminator_hv8.npy', History)
